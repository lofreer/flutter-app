...
import 'package:demo/model/tab_info_model.dart';
import 'package:demo/page/rank/rank_list_page.dart';
...
class _RankPageState extends State<RankPage>
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        appBar: AppBar(
          title: Text(MString.popularity_list,
              style: TextStyle(
                  fontSize: 18,
                  color: Colors.black,
  ...
  void _loadData() async {
    await ApiService.request(ApiService.rank_url, success: (result) {
